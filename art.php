	...
	<div class="container">
			...
			<div class="row">
				<div class="col-md-8">
					 <div class="logo">
                            <a href="#">
                                <img src="images/p.png" style="height: 100%;width: 100%; " alt="Admin">
                            </a>
                        </div>
				</div>

				<div class="col-md-4" style=" margin-top: 5em">
			        <h1 style="color:black;">Temple <span style="color: dodgerblue">International Baptist</span> Academy</h1>
                        	...
                        	<label></label>
                        	<input type="text" name="" class="form-control" placeholder="Year and Section">
                        ...
                        <h2>Teachers Report</h2><input type="text" name="" class="form-control">
